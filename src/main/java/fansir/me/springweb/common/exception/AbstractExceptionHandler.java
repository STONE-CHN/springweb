...
import fansir.me.springweb.common.constant.ResultCode;
import fansir.me.springweb.common.dto.ResultDto;
import fansir.me.springweb.common.dto.ResultDtoFactory;
import fansir.me.springweb.showcase.dto.ValidationResultDto;
...
public abstract class AbstractExceptionHandler {
    ...
    public ResultDto buildErrorDto(final Exception ex, final Object handler, final String formId){
        if(StringUtils.isEmpty(formId)){
            return ResultDtoFactory.toCommonError("formId can not be null!");
        }else{
            ResultDto error = new ResultDto();
            error.setMessage("valid failed!");
    ...
    private String getErrorField(String fieldName, Class<?> rootClz, boolean notManually) {
        ...
        if (pathInfo != null && pathInfo.length > 0) {
            for (String part : pathInfo) {
                ...
                String arrayIndex = "";
                Pattern p = Pattern.compile(ApplicationConstant.ARRARY_REGEXP);
